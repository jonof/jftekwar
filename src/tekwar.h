...
WASSTATIC int recording;

WASSTATIC int vesares[7][2];
...
WASSTATIC int ototalclock, gotlastpacketclock, smoothratio;
...
WASSTATIC int animatevel[MAXANIMATES], animateacc[MAXANIMATES], animatecnt;
#endif
